using CodeHub.Services.Implementations;
...
namespace CodeHub
{
    public static class AppSettings
    {
        ...
        {
            return AESService.Decrypt(_config[key]);
        }

        private static Type GetSettingAsType<Type>(object obj, Func<object, Type> callerConverter)
        {
            if (obj != null)
            {
